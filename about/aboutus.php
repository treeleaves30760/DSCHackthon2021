	...
	<body class="no-sidebar is-preload">
		<header class="header">
    		<nav class="navbar navbar-expand-lg fixed-top py-3">
        		<div class="container"><a href="../index.php" class="navbar-brand text-uppercase font-weight-bold">梅竹Eat!</a>
		...
		<div id="page-wrapper">
			...
			<!-- Main -->
				<div id="main" class="wrapper style2 upp">
                ...
                <div class="col-md-5">
                  <form action="./php/sendContact.php" method="post">
                      ...
                      <fieldset class="form-group text-xs-right">
                          <input type="submit" class="btn btn-success submitMessage" value="送出"></button>
                      </fieldset>
                  </form>
              </div>
            </div>
